        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 text-sm mb-4">
              ...
              Chúng tôi cam kết mang đến dịch vụ chất lượng, an toàn và đáng tin cậy.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/search-helper" className="text-gray-600 hover:text-blue-600 text-sm transition-colors">
                  Tìm người giúp việc
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/notifications" className="text-gray-600 hover:text-blue-600 text-sm transition-colors">
                  Thông báo
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/safety" className="text-gray-600 hover:text-blue-600 text-sm transition-colors">
                  An toàn & Bảo mật
                </Link>
              </li>
            </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">support@findhelper.vn</p>
              </div>
            </div>
