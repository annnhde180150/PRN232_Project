...
export interface SignalRCallbacks {
    ...
    onUserStatusChanged?: (userId: string, userType: string, isOnline: boolean) => void;
...
class SignalRService {
    ...
    private setupConnection() {
        ...
        const hubUrl = process.env.NEXT_PUBLIC_SIGNALR_HUB_URL || 'https://localhost:7192/notificationHub';
    ...
    private setupEventHandlers() {
        ...
        this.connection.on('UserStatusChanged', (userId: string, userType: string, isOnline: boolean) => {
    ...
    public async sendChatMessageToConversation(conversationId: string, message: ChatMessage): Promise<boolean> {
        return this.invoke('SendChatMessageToConversation', conversationId, message);
    }
